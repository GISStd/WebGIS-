...
var formatLength = function (line) {
    ...
    if (geodesicCheckbox.checked) { //若使用测地学方法测量
        ...
        length = new ol.Sphere().getLength(line, { "projection": sourceProj, "radius": 6378137 });
    } else {
...
var formatArea = function (polygon) {
    ...
    if (geodesicCheckbox.checked) {//若使用测地学方法测量
        ...
        area = Math.abs(new ol.Sphere().getArea(geom, { "projection": sourceProj, "radius": 6378137 })); //获取面积
    } else {
